 ...
 */
class LocalServerThread implements ServerThread {

    private static final Logger LOGGER = LoggerFactory.getLogger(LocalServerThread.class);
    ...
    public LocalServerThread(int port, HttpRequestHandler servlet) {
