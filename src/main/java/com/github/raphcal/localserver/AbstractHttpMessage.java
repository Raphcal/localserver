...
abstract class AbstractHttpMessage {
	...
	private ByteArrayOutputStream contentBuilder = new ByteArrayOutputStream();
	...
	/**
	 * Défini le contenu en tant que String.
	 * La chaîne sera convertie en octets à l'aide du charset défini.
	 * 
	 ...
	 * 
	 * @param content Contenu.
	 * @param refresh <code>true</code> pour mettre à jour les en-têtes Content-Type et Content-Length.
	 * @see #setCharset(java.nio.charset.Charset) 
	 */
	...
	/**
	 * Ajoute la chaîne donnée au contenu.
	 * La chaîne sera convertie en octets à l'aide du charset défini.
	 * 
	 * @param content Contenu.
	 * @param refresh <code>true</code> pour mettre à jour les en-têtes Content-Type et Content-Length.
	...
	/**
	 * Récupère le contenu sous forme de String.
	 * Les octets sont convertis en chaîne grâce au charset courant.
	 * 
	 ...
	 * 
	 * @return La chaîne séparant les valeurs du formulaire ou <code>null</code> si non défini.
	 */
